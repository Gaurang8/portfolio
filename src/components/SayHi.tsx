...
const SayHi = () => {
    return (
        <div className=' p-2 w-full mt-20'>
            <div className=" rounded-3xl w-full h-full bg-gradient-to-r from-[#03031e] to-[#1f1111] pt-7 pb-4 flex flex-col">
                ...
                <div className=" flex flex-col gap-5 px-8 pb-4">
                    ...
                    <div className=" flex gap-8 pt-3">
                        <button className='bg-gradient-to-r from-[#80ff86c4] to-[#0b4b1be0] w-fit bg-clip-text text-transparent flex gap-1 items-center'>
                            <Image src={whatsappSvg} alt="" className=" h-4 w-4 -mb-[1px] object-contain inline-block " />    
                            whatsapp</button>
                        <button className='bg-gradient-to-r from-[#e79654e8] to-[#4747fb] w-fit bg-clip-text text-transparent flex gap-1 items-center'>
